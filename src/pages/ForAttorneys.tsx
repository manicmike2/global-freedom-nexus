...
const faqItems = [
  ...
  { question: "What programs do you recommend?", answer: "We specialize in Caribbean Citizenship by Investment programs (Grenada, Saint Kitts & Nevis, Antigua & Barbuda, Dominica, Saint Lucia) and Turkey, plus Golden Visa and residency programs (Portugal, Greece, Malta MPRP, UAE, Panama). We recommend programs based on each client's unique objectives, not on commission structures." },
...
const ForAttorneys = () => {
  return (
    <div className="min-h-screen bg-background">
      <PageSEO
        title="Investment Migration for Immigration Attorneys | GFC"
        description="Strategic investment migration partnership for US immigration attorneys. Expand your practice with GFC's CBI and Golden Visa expertise."
