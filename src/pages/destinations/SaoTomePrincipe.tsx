...
const data = {
  ...
  seoDescription: "São Tomé & Príncipe citizenship by investment from $90,000. Discreet second passport program. Expert advisory from Global Freedom Capital. Free consultation.",
