...
const data = {
  ...
  seoDescription: "Dominica citizenship by investment from $200,000 — one of the most affordable CBI programs. 145+ visa-free countries. Free consultation with GFC.",
