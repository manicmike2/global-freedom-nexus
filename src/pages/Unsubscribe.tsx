...
const Unsubscribe = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <PageSEO title="Unsubscribe | GFC" description="Unsubscribe from Global Freedom Capital email communications." canonical="https://www.globalfreedomcapital.com/unsubscribe" noindex />
      <Header />
