...
const allDestinations = [
  ...
  { name: "Malta", region: "Europe", investment: "From €150,000", type: "Residency", advantage: "Lifetime EU residency with Schengen access", image: destMalta, timeline: "4-6 months", visaFree: "Schengen access", description: "The Malta Permanent Residence Programme (MPRP) grants lifetime EU residency on a stable, English-speaking Mediterranean island, with Schengen mobility and a globally respected regulatory environment." },
...
const faqItems = [
  { question: "Which destination is best for my family?", answer: "The ideal destination depends on your specific objectives: whether you prioritize speed (Caribbean Citizenship by Investment), EU access (Portugal, Greece, Malta MPRP residency), tax optimization (UAE, Panama), or U.S. market access (Grenada, Turkey via E-2 treaty). Our advisors conduct a thorough assessment of your goals before recommending any jurisdiction." },
  { question: "Can I apply to multiple programs simultaneously?", answer: "Yes, it is possible to apply to multiple programs at the same time. Some families choose to pursue a Caribbean Citizenship by Investment for immediate global mobility while also starting a European Golden Visa for long-term EU access. We can help you strategize a multi-program approach." },
  { question: "How do investment amounts compare across regions?", answer: "Caribbean Citizenship by Investment programs range from $100,000 (Dominica) to $250,000 (St Kitts). European residency starts at €150,000 (Malta MPRP) and €250,000 (Greece Golden Visa). Global options include Turkey ($400,000), UAE ($545,000), and Panama ($300,000)." },
        ...
        <div className="container mx-auto px-6 lg:px-12 max-w-4xl">
          ...
          <div className="space-y-12">
            {[
              ...
              { region: "Europe", desc: "European Golden Visa and residency programs provide access to the world's most established economies and the Schengen Area. From Greece's affordable Golden Visa at €250,000 to Malta's lifetime Permanent Residence Programme (MPRP), European programs suit families planning long-term relocation or generational positioning within the EU.", link: "/golden-visa" },
